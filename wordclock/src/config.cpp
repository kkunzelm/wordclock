...
void Config::save() {
  ...
  // KHK HaloLeds
  doc["halo_status"] = Config::halo_status;
  doc["halo_color_r"] = Config::halo_color.r;
  doc["halo_color_g"] = Config::halo_color.g;
  doc["halo_color_b"] = Config::halo_color.b;
  doc["halo_brightness"] = Config::halo_brightness;
...
void Config::load() {
  ...
  Config::halo_status = false;
  Config::halo_brightness = 0.5;
  Config::halo_color.r = 255;
  Config::halo_color.g = 100;
  Config::halo_color.b = 100;
  ...
  deserializeJson(doc, file);
    ...
    Config::color_bg.r = doc["color_bg_r"].as<uint8_t>();
    Config::color_bg.g = doc["color_bg_g"].as<uint8_t>();
    Config::color_bg.b = doc["color_bg_b"].as<uint8_t>();

    Config::color_fg.r = doc["color_fg_r"].as<uint8_t>();
    Config::color_fg.g = doc["color_fg_g"].as<uint8_t>();
    Config::color_fg.b = doc["color_fg_b"].as<uint8_t>();
  ...
  if(doc["brightness"]) {
    ...
    Config::halo_color.r = doc["halo_color_r"].as<uint8_t>();
    Config::halo_color.g = doc["halo_color_g"].as<uint8_t>();
    Config::halo_color.b = doc["halo_color_b"].as<uint8_t>();

    if(doc["halo_status"]){
        Config::halo_status = doc["halo_status"].as<bool>();
    }

  if(doc["halo_brightness"]) {
...
// KHK
bool Config::halo_status{};
color_t Config::halo_color{};
double Config::halo_brightness{};
